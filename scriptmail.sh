...
if [ "$choix" = "1" ]; then
    ...
    echo "Choisir le bureau à installer "
    echo " "
	echo "1- Désinstallation du bureau UNITY "
	echo " "
	echo "2- Désinstallation du bureau GNOME "
	echo " "
	echo "3- Désinstallation du bureau KDE "
	echo " "
	echo "4- Désinstallation du bureau XFCE "
	echo " "
	echo "faites votre choix:"
	read bureau

	echo "Installation du paquet liés à la desintallation des pacquet ophelin dans notre serveur"
	...
	if [ "$bureau" = "1" ]; then
		...
		echo " Bienvenu dans l'assistant de désinstallation du bureau GNOME avec tous ces programmes "
		echo " "
		...
		echo " Bienvenu dans l'assistant de désinstallation du bureau KDE avec tous ces programmes "
		echo " "
		...
		echo " Bienvenu dans l'assistant de désinstallation du bureau XFCE avec tous ces programmes "
		echo " "
